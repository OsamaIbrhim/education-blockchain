...
export default function Home() {
  ...
  const handleLogin = async () => {
    try {
      ...
      // 4. Redirect the user to the dashboard based on their role
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            {(selectedRole === 'institution' || selectedRole === 'employer') && (
              <Text>{t('noExtraFieldsRequired') || 'No extra fields required for this role.'}</Text>
            )}
          </ModalBody>
          <ModalFooter>
