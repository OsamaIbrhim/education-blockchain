...
export const CONFIG = {
  ...
  INSTITUTION_ADDRESS: process.env.NEXT_PUBLIC_INSTITUTION_OWNER_ADDRESS || '',
  ...
  STUDENT_ACADEMIC_MANAGER_CONTRACT_ADDRESS: process.env.NEXT_PUBLIC_STUDENT_ACADEMIC_MANAGER_CONTRACT_ADDRESS || '',
  COURSE_MANAGEMENT_ADDRESS: process.env.NEXT_PUBLIC_COURSE_MANAGEMENT_ADDRESS || ''
};
